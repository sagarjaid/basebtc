...
// For instance:
// - Hero: "basedinbitcoin helps developers launch startups fast"
// - Problem Agitation: "Developers spend too much time adding features, get overwhelmed, and quit." (not about basedinbitcoin at all)
// - Features: "basedinbitcoin has user auth, Stripe, emails all set up for you"
const Problem = () => {
  return (
